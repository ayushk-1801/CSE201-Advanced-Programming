...
public class Admin extends AdminUser implements AdminInterface {
    ...
    public void viewFeedback() {
        ...
        if (course != null) {
            ...
            if (feedbackList.isEmpty()) {
                ...
                System.out.println("+----+----------------------------------------+------------------------------------------------+");
                System.out.println("| ID | Student Name                           | Feedback                                       |");
                System.out.println("+----+----------------------------------------+------------------------------------------------+");
                for (int i = 0; i < feedbackList.size(); i++) {
                    Feedback<?> feedback = feedbackList.get(i);
                    System.out.printf("| %-2d | %-40s | %-46s |\n",
                            i + 1,
                            feedback.getStudentEmail(),
                            feedback.getFeedback().toString());
                }
                System.out.println("+----+----------------------------------------+------------------------------------------------+");
            }
        } else {
    ...
    public void assignTeachingAssistant() {
        ...
        for (TeachingAssistant t : Props.getTeachingAssistants()) {
            if (t.getEmail().equals(taEmail)) {
                ta = t;
                break;
            }
        }
        ...
        if (ta != null && course != null) {
            ...
            ta.setCourse(course);
            System.out.println("Teaching Assistant assigned to course successfully.");
        } else {
            System.out.println("Teaching Assistant or course not found.");
        }
    }
}
